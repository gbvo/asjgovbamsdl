...
class PyramidVisionTransformerImpr(nn.Module):
    def __init__(self,
        ...
        self.norm1 = norm_layer(embed_dims[0], eps=1e-6)
        ...
        self.norm2 = norm_layer(embed_dims[1], eps=1e-6)
        ...
        self.norm3 = norm_layer(embed_dims[2], eps=1e-6)
        ...
        self.norm4 = norm_layer(embed_dims[3], eps=1e-6)
